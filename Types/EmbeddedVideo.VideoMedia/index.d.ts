...
/**
[{"kind":"introducedBy","version":3345490190}]
*/


/**
'VideoMedia' exposes a set of APIs that are specifically tailored for controlling video playback.
*/
declare interface VideoMedia {
...
playing back the video. Note that the progress normalized and
is in [0.0, 1.0].
Also cf. seek() API.
*/
...
/**
```
(get) videoMediaId: number
(set) videoMediaId: number
```
*/
videoMediaId: number
