/// <reference path="../DynamicExtrusion.BrushType/index.d.ts" />
...
/**
```
addWorldPointsForDebugOnly(points: Array<Point3D>): void
```

This method is for internal debug use only. It is used to add points manually in World Space in current units to Dynamic Extrusion.
This way, you can keep building the same Dynamic Extrusion stroke procedurally, and check how the stroke behaves when specified points are added.
*/
addWorldPointsForDebugOnly(points: Array<Point3D>): void
