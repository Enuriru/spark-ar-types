...
/**
[{"kind":"introducedBy","version":3350789135}]
*/


/**
`PlatformTextureMediaVideo` represents "video" media that was picked from the Platform that is
...
*/
declare interface PlatformTextureMediaVideo extends PlatformTextureMediaBase {
...
playing back the PlatformTexture. Note that the progress normalized and
is in [0.0, 1.0].
Also cf. seek() API.
*/
